      ...
      cell: ({ row }) => (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-48 glass border-white/10">
            ...
            <DropdownMenuItem className="cursor-pointer gap-2 text-xs font-medium"><Edit size={14} className="text-amber-500" /> Edit Customer</DropdownMenuItem>
            <DropdownMenuSeparator className="bg-white/5" />
            <DropdownMenuItem className="cursor-pointer gap-2 text-xs font-medium text-red-500 hover:bg-red-500/10"><Trash2 size={14} /> Remove Client</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      ),
    },
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          <motion.div 
            ...
            className="p-6 glass border-white/10 rounded-3xl flex items-center gap-6"
          >
